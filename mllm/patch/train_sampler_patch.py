...
from transformers.trainer import (RandomSampler,has_length)
from transformers.trainer_pt_utils import logger


# old version from https://github.com/OpenGVLab/InternVL/blob/main/internvl_chat/internvl/patch/train_sampler_patch.py
...
class CustomLengthGroupedSampler(Sampler):
    r"""
...
# patch trainer, modified by hungingface transformers version ,
# 如果transformers版本较低，需要
    ...
    if self.args.group_by_length:
        ...
        try:
            ...
            try:  
                ...
                raise ValueError("The custom LengthGroupedSampler is not avaliable.")
    else:
