...
@register_collator("intern2vl")
class IMGForDataCollator(BaseDataCollator):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        # if 'gt_pose_values' in instances[0]:
        #     all_gt_pose_values = [instance["gt_pose_values"] for instance in instances]
        #     batch["gt_pose_values"] = torch.concat(all_gt_pose_values, dim=0)
