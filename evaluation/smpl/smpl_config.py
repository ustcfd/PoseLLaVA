...
SMPL_MEAN_PARAMS_PATH = 'evaluation/smpl/additional/neutral_smpl_mean_params_6dpose.npz'
J_REGRESSOR_EXTRA_PATH = 'evaluation/smpl/additional/J_regressor_extra.npy'
COCOPLUS_REGRESSOR_PATH = 'evaluation/smpl/additional/cocoplus_regressor.npy'
H36M_REGRESSOR_PATH = 'evaluation/smpl/additional/J_regressor_h36m.npy'
VERTEX_TEXTURE_PATH = 'evaluation/smpl/additional/vertex_texture.npy'
CUBE_PARTS_PATH = 'evaluation/smpl/additional/cube_parts.npy'
